  ...
  return (
    <Container size="lg" className="py-4 md:py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <Link
          href="/superadmin/drink-logs"
          className="bg-card text-card-foreground border-2 border-border rounded-xl p-6 hover:border-primary/40 hover:shadow-md transition-all group shadow-sm"
        >
          <h2 className="text-xl font-bold text-foreground mb-2 group-hover:text-primary transition-colors">Drink Logs</h2>
          <p className="text-muted-foreground font-medium">View and remove individual logged drinks/points.</p>
        </Link>
