...
export default function UserAchievements({ user, allUsers, rank }: UserAchievementsProps) {
  ...
  const achievements: Achievement[] = [
    ...
    // Consistency achievements
    {
      id: 'daily_drinker',
      name: 'Daily Habit',
      description: 'Log drinks on 7 different days',
    ...
    // Special achievements
    {
      ...
      description: 'Log both regular drinks and shots',
    ...
    {
      id: 'shot_specialist',
      name: 'Shot Specialist',
      description: 'Log 20 shots',
                      ...
                      {achievement.maxProgress && (
                        <div className="space-y-1">
                          <div className="flex justify-between text-xs text-gray-500">
                            <span>Progress: {achievement.progress || 0} / {achievement.maxProgress}</span>
